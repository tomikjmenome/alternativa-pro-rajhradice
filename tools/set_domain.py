...
n = 0
for f in ["index.html", "kandidati.html", "program.html", "videa.html", "jak-volit.html", "gdpr.html", "404.html", "robots.live.txt", "robots.txt", "sitemap.xml", "js/data.js"]:
    if os.path.exists(f):
...
if index:
    ...
    for f in ["index.html", "kandidati.html", "program.html", "videa.html", "jak-volit.html"]:
